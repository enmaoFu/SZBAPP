 ...
 * @date 2016-12-23
 */
public class BaseLyRoundImageView extends ImageView {
	...
	public BaseLyRoundImageView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context, attrs);
	}

	public BaseLyRoundImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
	}

	public BaseLyRoundImageView(Context context) {
		super(context);
		init(context, null);
	}
