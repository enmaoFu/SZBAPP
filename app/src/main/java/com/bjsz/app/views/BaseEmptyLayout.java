 ...
 * @author enmaoFu
 * @date 2016-12-23
 * https://github.com/quanke/AndroidEmptyLayout
 */
public class BaseEmptyLayout extends LinearLayout{
    ...
    private int mErrorDrawable = R.mipmap.base_frame_ic_error;
    private int mEmptyDrawable = R.mipmap.base_frame_ic_empty;
    private int mLoadingDrawable = R.mipmap.base_frame_ic_loading;
    ...
    public BaseEmptyLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public BaseEmptyLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            setTopDrawables(mLoadingMessageView,mLoadingDrawable);// loading 不能已经有loading image view ，不能直接设置TopDrawable
    ...
    private void setDefaultValues() {
        if (mEmptyView==null) {
            mEmptyView = (ViewGroup) mInflater.inflate(R.layout.base_frame_view_empty_layout, null);
        ...
        if (mLoadingView==null) {
            mLoadingView = (ViewGroup) mInflater.inflate(R.layout.base_frame_view_loading_layout, null);
        ...
        if (mErrorView==null) {
            mErrorView = (ViewGroup) mInflater.inflate(R.layout.base_frame_view_error_layout, null);
