 ...
 * @date 2017-01-05
 */
public class BaseRoundProgressBarView extends View {
    ...
    private final int mTxtStrokeWidth = 25;
    ...
    public BaseRoundProgressBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(Color.rgb(80,189,254));
        canvas.drawArc(mRectF, -90, ((float) mProgress / mMaxProgress) * 360, false, mPaint);

        // 绘制进度文案显示
        mPaint.setStrokeWidth(mTxtStrokeWidth);
        String text = "正常率"+mProgress + "%";
        int textHeight = height / 7;
